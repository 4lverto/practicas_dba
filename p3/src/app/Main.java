 ...
 *
 * Será el punto de entrada para el sistema de simulación, iniciando el
 * controlador de simulación y comenzando dicho proceso.
 */
public class Main {

    /**
     * @brief Método principal que contiene la lógica de ejecución del
     * simulador.
